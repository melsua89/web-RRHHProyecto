...
document.addEventListener("DOMContentLoaded", function(){
    ...
    tblVacaciones = new DataTable('#tblVacaciones', {
        fixedHeader: true,
        responsive: true,
        select: true,
        language,
        ajax: {
            url: base_url + "Vacaciones/mostrar", // URL del controlador
            dataSrc: ''
        },
        columns: [
            {
        ...
        buttons: [
            {
                extend: 'pdf',
                footer: true,
                title: 'Planilla de Vacaciones ' + dia + "/" + mes + "/" + anio,
                filename: 'planilla_Vacaciones_' + dia + mes + anio + horas + minutos + segundos,
                text: '<button class="btn btn-danger" data-toggle="tooltip" data-placement="top"><i class="fa-solid fa-file-pdf"></i></button>'
            },
            {
                extend: 'excel',
