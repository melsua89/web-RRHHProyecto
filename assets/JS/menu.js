...
// Sub-Menu
    ...
    $('#sub-menu-vacaciones').click(function (event) {
        event.preventDefault();
        cargarContenido($(this).attr('href')); // Llama la función para cargar la URL de vacaciones
    });
 ...
 // End-Sub-Menu
    ...
    function cargarContenido(url) {
        $.ajax({
            ...
            type: 'GET',
            success: function (data) {
                $('#contenedorSeleccion').html(data);
            },
            error: function () {
                $('#contenedorSeleccion').html('Error al cargar la página.'); 
            }
        });
    }
});
