    ...
    <ul class="nav-list" style="padding-left: 0;">
      	...
      	<li id="Menu_planillas">
        	...
        	<div class="sub-menu" >
				...
				<div class= "item3">
        	        <a class="nav-link" href="<?php echo base_url; ?>Vacaciones" style="margin: 0.1rem;">
        	        	<i class='bx bx-dollar'></i>                    
        	        	<span class="links_name" >Planillas vacaciones</span>
        	        </a>
        	        <span class="tooltip3">Planillas vacaciones</span>
        	    </div>                                                       
        	</div>
      	</li >
