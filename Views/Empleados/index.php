                        ...
                        <div class="row">
                            <div style="overflow: auto;height: 500px">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 my-2">
                                        <div class="form-outline mb-2">
                                            <label class="form-label" for="txtCuentaBanco" style="width: 100%">Cuenta Bancaria</label>
                                            <input type="text" id="txtCuentaBanco" name="txtCuentaBanco" placeholder="Número de Cuenta Bancaria"
                                                class="form-control form-control-lg" style="font-size:15px; width: 100%" />
                                        </div>
                                    </div>
