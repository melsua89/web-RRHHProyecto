...
class Empleados extends Controller{
    ...
    public function validarCampos() {
        ...
        $cuenta_banco = $this->validarCadenas($_POST['txtCuentaBanco']);

        if($sueldo == null && $dui == null){
            return ["key" => $id, "value" => [$pnombre, $snombre, $papellido, $sapellido, $sexo, $fecha_nacimiento, $fecha_ingreso, $cargo, $seguro, $pension,  $afiliado, $cuenta_banco]];   
        }else{
            return ["key" => $id, "value" => [$pnombre, $snombre, $papellido, $sapellido, $dui, $sexo, $fecha_nacimiento, $fecha_ingreso, $cargo, $sueldo, $seguro, $pension,  $afiliado, $cuenta_banco]];
        }
    }
