...
--
-- Servidor: localhost
-- Tiempo de generación: 19-11-2024 a las 22:14:38
...
CREATE TABLE `vacaciones` (
  ...
  `dias_base` int(11) DEFAULT NULL,
  `vacaciones` double DEFAULT NULL,
  `renta_vacaciones` double DEFAULT NULL,
  `liquido_pagar` double DEFAULT NULL,
  `anio_planilla` int(11) DEFAULT NULL,
  `estado` int(11) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `vacaciones` (`id`, `id_empleado`, `sueldo_base`, `sueldo_calculo`, `anios_laborales`, `dias_base`, `vacaciones`, `renta_vacaciones`, `liquido_pagar`, `anio_planilla`, `estado`) VALUES
(5, 40, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(7, 46, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(8, 47, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(9, 48, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(10, 49, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(11, 50, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(12, 51, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(13, 52, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(14, 53, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1);
